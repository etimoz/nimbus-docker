...
/usr/src/nimbus-eth2/build/nimbus_beacon_node --tcp-port=9100 --udp-port=9100 --web3-url=$VOTING_ETH1_NODE --data-dir=/var/lib/nimbus --log-file=/var/lib/nimbus/beacon_node.log --network=$NETWORK --graffiti="$GRAFFITI"
